...
class GlobalSettingsUpdate(BaseModel):
    ...
    capital_pool_percentage: float = Field(ge=0, le=1, default=0.50)
    labour_pool_percentage: float = Field(ge=0, le=1, default=0.50)
    contingency_pot_minimum: float = Field(ge=0, default=10000.0)
...
class GlobalSettingsResponse(BaseModel):
    ...
    capital_pool_percentage: float
    labour_pool_percentage: float
    contingency_pot_minimum: float
